...
// PROPS — recibe texto, link opcional, función de cierre opcional y confirmación opcional
function Alerta({ texto, linkTexto, linkRuta, onClose, onConfirm, confirmTexto = "Confirmar" }) {
  return (
