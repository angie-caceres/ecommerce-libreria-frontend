...
export default function GestionImagenes({token}) {
  ...
  const handleEliminar = async (id) => {
    if (!window.confirm("¿Seguro que querés eliminar esta imagen de la base de datos?")) return
    ...
    try {
      ...
      // Filtramos el estado local para que desaparezca al instante visualmente
